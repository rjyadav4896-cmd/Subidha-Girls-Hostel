...
export default function ContactSection() {
  const contactInfo = [
    { icon: UserRound, title: 'Admin', content: 'Subidha Girls Hostel Admin', action: null },
    { icon: Phone, title: 'WhatsApp / Phone', content: '+977 9706666497', action: 'tel:+9779706666497' },
    { icon: Mail, title: 'Email', content: 'pickyourhostel1@gmail.com', action: 'mailto:pickyourhostel1@gmail.com' },
