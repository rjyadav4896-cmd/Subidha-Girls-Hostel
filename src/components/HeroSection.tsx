...
export default function HeroSection({ onReadyToLive }: { onReadyToLive: () => void }) {
  const highlights = [
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 py-12 sm:px-6 sm:py-16 lg:px-8 md:py-24">
        <div className="grid lg:grid-cols-[1.05fr_0.95fr] gap-10 items-center">
          <div>
            ...
            >
              <a href="tel:+9779706666497" className="rounded-lg bg-sky-400 px-6 py-3 text-center font-bold text-blue-950 transition-colors hover:bg-sky-300">
                Call Hostel
              </a>
              <a
              ...
              <button
                type="button"
                onClick={onReadyToLive}
                className="rounded-lg border border-sky-300/50 bg-white px-6 py-3 text-center font-bold text-blue-950 transition-colors hover:bg-sky-50"
              >
                Ready to Live
              </button>
            </motion.div>
